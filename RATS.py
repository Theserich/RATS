...
from Library.versionControl import get_version, _is_newer
...
print(f"RATS version: {CURRENT_VERSION}")
    ...
    try:
        ...
        def _shutdown_logging_safely():
            ...
            try:
                ...
                pass
            for handler in (qt_handler, file_handler):
                try:
                    handler.flush()
                except Exception:
                    pass
                try:
                    ...
                    pass
        app.aboutToQuit.connect(_shutdown_logging_safely)
        exit(app.exec_())
